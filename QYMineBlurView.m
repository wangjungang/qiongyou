...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _backgroundGlassView.backgroundColor = [UIColor blackColor];
...
- (void)setBlurLevel:(float)blurLevel {
    self.backgroundImageView.alpha = blurLevel*4;
